...
import { McpServerConfig, McpServerStatus, McpTool, StreamingHttpMcpServerConfig } from '../types';
...
export class StreamingHTTPTransportHandler extends EventEmitter implements TransportHandler {
    private mcpClient: Client | null = null;
    private transport: StreamableHTTPClientTransport | null = null;
    private config: StreamingHttpMcpServerConfig;

    constructor(config: McpServerConfig) {
        super();
        if (config.transportConfig.type !== 'streaming-http') {
            throw new Error('Invalid transport type for Streaming HTTP handler');
        }
